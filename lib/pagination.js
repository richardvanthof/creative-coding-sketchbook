const pagination = (sketches) => {
  ...
  homeLink.style.marginRight = ".5em";
  homeLink.style.alignItems = "baseline";
  homeLink.classList.add("btn", "btn-light");
  homeLink.style.background = '#fff'
  homeLink.style.borderColor = '#dee2e6'
  ...
  paginator.querySelectorAll("page-link").forEach(el => {
    el.style.height = '100%';
  })
